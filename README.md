...
> **Disclaimer**: This project is 100% vibe coded. Every line was generated by AI agents working in parallel, often concurrently modifying the same codebase. It is not exemplary Gleam code. Do not use it as a reference for how to write Gleam. If you want to learn Gleam, read the [official language tour](https://tour.gleam.run/) instead.
